    ...
    <View style={tabStyles.iconWrap}>
      {focused ? (
        <LinearGradient colors={[colors.goldLight, colors.gold]} style={tabStyles.activeChip}>
          <Feather name={name} size={16} color="#000" />
        </LinearGradient>
      ) : (
        <View style={tabStyles.inactiveChip}>
          <Feather name={name} size={16} color={colors.textMuted} />
        </View>
      )}
  ...
  return (
    ...
    >
      <Tabs.Screen
        name="index"
        options={{
          tabBarIcon: ({ focused }) => <TabIcon name="folder" label="Cases" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="play"
        options={{
          tabBarIcon: ({ focused }) => <TabIcon name="zap" label="Play" focused={focused} />,
        }}
      />
      <Tabs.Screen
        name="profile"
        options={{
          tabBarIcon: ({ focused }) => <TabIcon name="shield" label="Profile" focused={focused} />,
        }}
      />
    </Tabs>
  );
